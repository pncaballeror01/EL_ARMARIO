...
@section('content')
    ...
    <nav class="bg-black py-3 border-bottom border-secondary sticky-top" style="border-color: #333 !important;">
        <div class="container d-flex justify-content-between align-items-center">
            <a href="{{ url('/') }}" class="p-0 d-flex align-items-center gap-2 text-white text-decoration-none"
                style="background: none; border: none; cursor: pointer;">
                <span class="material-symbols-outlined" style="color: #E7FF00;">arrow_back</span>
                <span class="font-monospace"
                    style="font-size: 0.85rem; font-weight: 700; letter-spacing: 1px;">VOLVER</span>
            </a>
    ...
    <section class="header-taquilla py-5">
        <div class="container">
            <div class="row align-items-center gy-4">
                ...
                {{-- Avatar + datos --}}
                <div
                    class="col-lg-6 d-flex flex-column flex-sm-row align-items-center text-center text-sm-start gap-3 gap-md-4">
                    <div class="avatar-neon">
                        <span class="material-symbols-outlined text-white"
                            style="font-size: clamp(2.5rem, 5vw, 3.5rem); color: #E7FF00 !important;">person</span>
                    </div>
                    <div>
                        ...
                        @if($perfil->ciudad)
                            <div class="d-flex align-items-center justify-content-center justify-content-sm-start gap-1 font-monospace small"
                                style="color: #ccc;">
                                <span class="material-symbols-outlined"
                                    style="font-size: 1rem; color: #E7FF00;">location_on</span>
                                <span>{{ strtoupper($perfil->ciudad) }}</span>
                            </div>
                        @endif
                        <span class="font-monospace mt-2 d-inline-block"
                            style="font-size: 0.7rem; color: #888; letter-spacing: 2px; text-transform: uppercase;">/// TU
                            PERFIL</span>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <a href="{{ route('camisetas.create') }}" class="btn-mando text-decoration-none">
                        <span class="material-symbols-outlined font-weight-bold"
                            style="font-size: inherit;">add_circle</span>
    ...
    {{-- FRANJA DECORATIVA --}}
    <div style="height: 8px; background: repeating-linear-gradient(45deg, #E7FF00, #E7FF00 10px, #000 10px, #000 20px);">
    </div>
                            ...
                            <a href="{{ route('camisetas.show', $camiseta->id) }}" class="text-decoration-none d-block">
                                <div class="card-inventario h-100 position-relative overflow-hidden">
                                    ...
                                    <div class="overflow-hidden" style="height: 260px;">
                                        ...
                                        @else
                                            <div class="w-100 h-100 d-flex align-items-center justify-content-center"
                                                ...
                                                <span class="material-symbols-outlined"
                                                    style="font-size: 3rem; color: #444;">image_not_supported</span>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="p-3" style="background-color: #1a1a1a; border-top: 1px solid #333;">
                                        <h5 class="text-white font-monospace fw-bold text-uppercase text-truncate mb-1"
                                        ...
                                        @if($camiseta->images->count() > 1)
                                            <div class="mt-1" style="font-size: 0.7rem; color: #555; font-family: monospace;">
                                                <span class="material-symbols-outlined"
                                                    style="font-size: 0.85rem; vertical-align: middle;">photo_library</span>
