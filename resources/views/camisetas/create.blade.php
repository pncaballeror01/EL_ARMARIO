...
<nav class="bg-black py-3 border-bottom border-secondary sticky-top">
    <div class="container d-flex justify-content-between align-items-center">
        <a href="{{ url()->previous() !== url()->current() ? url()->previous() : route('dashboard') }}" class="text-decoration-none d-flex align-items-center text-white custom-hover">
            ...
            <span class="font-monospace small fw-bold">ABORTAR MISIÓN</span>
        </a>
...
<link rel="stylesheet" href="{{ asset('css/camisetas.css') }}">
...
<div class="title-banner py-5 px-3 px-md-5">
    ...
    <div class="container position-relative">
        <h1 class="page-title mb-0">
            AÑADIR NUEVA<br>
            <span class="text-primary">JOYA AL ARMARIO <span class="d-none d-md-inline" style="color: #444;">///</span></span>
        </h1>
    </div>
</div>
...
<section class="py-5 position-relative">
    <div class="container" style="max-width: 900px;">
        ...
        <!-- Formulario (La acción apuntaría al controlador de creación) -->
        <form action="{{ route('camisetas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="equipo" class="form-control input-tactical w-100" placeholder="Ej: FC BARCELONA '96" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="talla" class="form-control input-tactical w-100" placeholder="Ej: XL / L" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="año" class="form-control input-tactical w-100" placeholder="Ej: 1994 / 94-95" required>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <select class="form-select select-tactical w-100" name="estado" required>
                        <option value="" selected disabled class="text-secondary">--- SELECCIONA ESTADO ---</option>
                        <option value="10/10 - NUEVA C/ ETIQUETAS">[ 10/10 ] NUEVA C/ ETIQUETAS</option>
                        <option value="9.5/10 - COMO NUEVA">[ 9.5/10 ] COMO NUEVA</option>
                        <option value="9/10 - USADA - EXCELENTE">[ 9/10 ] USADA - EXCELENTE</option>
                        <option value="8/10 - USADA - MUY BUENA">[ 8/10 ] USADA - MUY BUENA</option>
                        <option value="7/10 - USADA - BUENA">[ 7/10 ] USADA - BUENA (DEFECTOS MENORES)</option>
                        <option value="6/10 - USO INTENSO">[ 6/10 ] USO INTENSO / VINTAGE GASTADA</option>
                    </select>
                </div>
                ...
                <div class="col-md-12 mt-4">
                    <div class="form-check form-switch d-flex align-items-center gap-3" style="background-color: #000; border: 2px solid var(--border-dark); padding: 1rem; padding-left: 4rem;">
                        <input class="form-check-input" type="checkbox" role="switch" id="intercambiableSwitch" name="intercambiable" value="1" checked style="width: 2.5rem; height: 1.25rem; transform: scale(1.5); margin-left: -3rem; cursor: pointer; border-color: var(--primary);">
                ...
                <div class="col-12 mt-4">
                    ...
                    <div class="textarea-container">
                        ...
                        <textarea name="descripcion" class="form-control input-tactical textarea-tactical w-100" placeholder="Usa CTRL + Intro para enviar. Cuenta la historia de esta pieza..." rows="5" required></textarea>
                    </div>
                </div>
            ...
            <div class="position-relative mt-5">
                <button type="submit" class="btn btn-launch d-flex justify-content-center align-items-center gap-3">
                    <span class="material-symbols-outlined launch-icon text-black">keyboard_double_arrow_up</span>
                    CREAR PUBLICACIÓN 
                    <span class="material-symbols-outlined launch-icon text-black">keyboard_double_arrow_up</span>
                </button>
